...
class FHIRTerminologyService {
                ...
                resource: [
                    {
                        ...
                        searchParam: [{ name: 'url', type: 'uri' }, { name: 'name', type: 'string' }]
                    },
                    {
                        type: 'ValueSet',
                        interaction: [{ code: 'read' }, { code: 'search-type' }],
    ...
    async searchTerms(req, res) {
        ...
        try {
            ...
            if (!system || system === 'http://id.who.int/icd/release/11/2023-01/mms/traditional-medicine') {
    ...
    async syncICD11Data(req, res) {
        try {
            ...
            const tm2Response = await axios.get('https://id.who.int/icd/release/11/2023-01/mms/traditional-medicine', {
