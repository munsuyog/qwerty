...
export default function NamasteToICD11TM2() {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          "http://localhost:3001/fhir/ConceptMap/namaste-to-icd11-tm2",
          {
            headers: {
    ...
    <div className="px-6 max-w-6xl mx-auto flex flex-col min-h-screen ml-100">
      ...
      <div className="mb-3 text-center">
        ...
        <p className="text-gray-600">
          Mapping between NAMASTE codes and WHO ICD-11 Traditional Medicine Module 2
        </p>
      </div>
      ...
      <div className="flex gap-4 mb-4 items-center">
        ...
        >
          ...
          <option value="icdCode">ICD-11 TM2 Code</option>
          <option value="icdDisplay">ICD-11 TM2 Display</option>
        </select>
            ...
            <Table>
              <TableHeader className="bg-gradient-to-r from-green-50 to-emerald-50">
                <TableRow>
                  ...
                  <TableHead className="w-[180px] text-gray-800 font-semibold">ICD-11 TM2 Code</TableHead>
                  <TableHead className="text-gray-800 font-semibold">ICD-11 TM2 Display</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
